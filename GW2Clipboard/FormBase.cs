...
{
    /// <summary>
    /// Based on https://github.com/mganss/BorderlessForm
    /// Originally based on http://customerborderform.codeplex.com/
    /// </summary>
    public class FormBase : Form
    {
        ...
        private void SetWindowRegion(IntPtr hwnd, int left, int top, int right, int bottom)
        {
            ...
            {
                Debug.WriteLine($"{DateTime.Now.Ticks}: L={box.left} R={box.right} {right}");
